...
using Opsive.UltimateCharacterController.Networking.Game;
    ...
    public class ShootableWeapon : UsableItem, IReloadableItem
    {
        ...
        private void ProjectileFire(float strength)
        {
            ...
            projectile.Initialize(m_CharacterLocomotion.Velocity + rotation * Vector3.forward * m_ProjectileFireVelocityMagnitude * strength, Vector3.zero, m_DamageAmount, m_ImpactForce, 
                                    m_ImpactForceFrames, m_ImpactLayers, m_ImpactStateName, m_ImpactStateDisableTimer, m_SurfaceImpact, m_Character);
#if ULTIMATE_CHARACTER_CONTROLLER_MULTIPLAYER
            if (m_NetworkCharacter != null) {
